...
public class SigUtils
{
    ...
    {
        System.out.println("getMDPPermission: " +  LocalTime.now());
    ...
    public static void setMDPPermission(PDDocument doc, PDSignature signature, int accessPermissions)
            throws IOException
    {
        System.out.println("setMDPPermission: " +  LocalTime.now());
    ...
    public static void checkCertificateUsage(X509Certificate x509Certificate)
            throws CertificateParsingException
    {
        System.out.println("checkCertificateUsage: " +  LocalTime.now());
    ...
    public static void checkTimeStampCertificateUsage(X509Certificate x509Certificate)
            throws CertificateParsingException
    {
        System.out.println("checkTimeStampCertificateUsage: " +  LocalTime.now());
        List<String> extendedKeyUsage = x509Certificate.getExtendedKeyUsage();
    ...
    public static void checkResponderCertificateUsage(X509Certificate x509Certificate)
            throws CertificateParsingException
    {
        System.out.println("checkResponderCertificateUsage: " +  LocalTime.now());
        List<String> extendedKeyUsage = x509Certificate.getExtendedKeyUsage();
        // https://tools.ietf.org/html/rfc5280#section-4.2.1.12
        if (extendedKeyUsage != null &&
    ...
    {
        System.out.println("getLastRelevantSignature: " +  LocalTime.now());
    ...
    {
        System.out.println("extractTimeStampTokenFromSignerInformation: " +  LocalTime.now());
    ...
    {
        System.out.println("getTsaCertificate: " +  LocalTime.now());
    ...
    public static X509Certificate getCertificateFromTimeStampToken(TimeStampToken timeStampToken)
            throws CertificateException
    {
        System.out.println("getCertificateFromTimeStampToken: " +  LocalTime.now());
        @SuppressWarnings("unchecked") // TimeStampToken.getSID() is untyped
        Collection<X509CertificateHolder> tstMatches =
                timeStampToken.getCertificates().getMatches(timeStampToken.getSID());
    ...
    {
        System.out.println("checkCrossReferenceTable: " +  LocalTime.now());
    ...
    {
        System.out.println("openURL: " +  LocalTime.now());
