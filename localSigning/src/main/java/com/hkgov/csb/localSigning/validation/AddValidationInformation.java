...
package com.hkgov.csb.localSigning.validation;


import com.hkgov.csb.localSigning.cert.CRLVerifier;
import com.hkgov.csb.localSigning.cert.CertificateVerificationException;
import com.hkgov.csb.localSigning.cert.OcspHelper;
import com.hkgov.csb.localSigning.cert.RevokedCertificateException;
import com.hkgov.csb.localSigning.util.SigUtils;

import com.hkgov.csb.localSigning.validation.CertInformationCollector.CertSignatureInformation;
...
public class AddValidationInformation
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        File inFile = new File("C:\\jpkcs11\\blank(apache)_noltv.pdf");
