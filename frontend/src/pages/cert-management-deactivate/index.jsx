...
const CertificateManagementDeactivate = () =>  {
  ...
  return (
    <div className={styles['exam-profile']}>
      <Typography.Title level={3}>Certificate Management - Deactivate</Typography.Title>
...
export default CertificateManagementDeactivate;