...
const RandomPreviewModal = (props) =>  {
  ...
  const columns = useMemo(() => [
    {
      ...
      width: 100,
      render: (row) => {
        return (<Button size={'small'} type={'primary'} onClick={() => runExamProfileAPI('previewPdf', row.id)}>Preview</Button>)
      }
    },
    {
      title: 'HKID',
  ...
  return (
    <Modal
      width={1920}
      title={`Random Preview Certificate`}
      closable={false}
      maskClosable={false}
...
export default RandomPreviewModal;