...
public final class ConvertUtils {
    ...
    public static Integer toInteger(Object anObj) {
        ...
        if (anObj instanceof Integer) {
            ...
            tmpResult = Integer.valueOf(((Number) anObj).intValue());

        } else {
            try {
                tmpResult = Integer.valueOf((toString(anObj)));
    ...
    public static Float toFloat(Object anObj) {
        ...
        if (anObj instanceof Float) {
            ...
            tmpResult = Float.valueOf(((Number) anObj).floatValue());
        } else {
            try {
                tmpResult = Float.valueOf(toString(anObj));
            } catch (NumberFormatException nfe) {
            }
        }
        return tmpResult;
