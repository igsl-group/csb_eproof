...
public final class Constants {
    ...
    public static final String DATE_PATTERN_3 = "d MMMM yyyy";
    public static final String DATE_PATTERN_4 = "yyyyMMdd";
    ...
    public static final String FILE_TYPE_GCIS_BATCH_XML = "GCIS_BATCH_XML";
