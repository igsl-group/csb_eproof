...
public class JwtHelper {
    ...
    public void verifyToken(String token, User user, UserSession userSession) {
        if (user == null || userSession == null) {
            throw new GenericException(ExceptionConstants.JWT_TOKEN_INVALID_EXCEPTION_CODE, ExceptionConstants.JWT_TOKEN_INVALID_EXCEPTION_MESSAGE);
        }
        ...
        if (!allowMultipleLogin && !tokenMatch) {
            throw new GenericException(ExceptionConstants.JWT_TOKEN_REPLACED_EXCEPTION_CODE, ExceptionConstants.JWT_TOKEN_INVALID_EXCEPTION_MESSAGE);
        }
        ...
        if (!tokenNotExpired) {
            throw new GenericException(ExceptionConstants.JWT_TOKEN_EXPIRY_EXCEPTION_CODE, ExceptionConstants.JWT_TOKEN_EXPIRY_EXCEPTION_MESSAGE);
        }
    }
